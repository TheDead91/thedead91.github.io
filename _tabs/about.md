...
PathGrooveBastard();
PDEndItAllAndReRunTheBastard();
ProcessPursueAndTwat();
RecordOpponentTwattageOccurrence();
SaySorryYouLittleBastard();
```
#### [Carmageddon 1 debugging symbols dumped](http://1amstudios.com/2014/12/02/carma1-symbols-dumped/)

## (2023) thedead@dellian:~$ whoami
```bash
       ___  ___     _____     _____     
       |  \/  |    |_   _|   |_   _|         
       | .  . |      | |       | |           
...
```
### ["And Splunk doesn’t work very well on paper"](https://www.youtube.com/watch?v=ddAtMMDeeq8)

## (2019) thedead@asian:~$ whoami
```bash
