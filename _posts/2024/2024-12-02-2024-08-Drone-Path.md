...
![08_01_DronePath_gumdrop1.png](/assets/img/posts/2024/2024-08-Drone-Path/08_01_DronePath_gumdrop1.png)  
...
![08_02_DronePath_login_sqli.png](/assets/img/posts/2024/2024-08-Drone-Path/08_02_DronePath_login_sqli.png)  

The same flaw works on the search function of the Elf Drone Workshop:  
![08_03_DronePath_workshop_sqli.png](/assets/img/posts/2024/2024-08-Drone-Path/08_03_DronePath_workshop_sqli.png)  
...
![08_04_DronePath_workshop_union.png](/assets/img/posts/2024/2024-08-Drone-Path/08_04_DronePath_workshop_union.png)  
...
* `'UNION SELECT username,avatar,bio FROM users--`
  ...
  | username | avatar | bio |
  | -------- | ------ | --- |
  | brynne | ![https://hhc24-dronepath.holidayhackchallenge.com/static/profilepictures/elf23.png](/assets/img/posts/2024/2024-08-Drone-Path/downloaded/elf23.png) | Brynne is the workshops master of drone aesthetics bedazzling every flying machine with shimmering gemstones and enchanted paints.<br/>She believes every drone deserves a touch of flair—because who says utility ca not be stylish? |
  | filo | ![https://hhc24-dronepath.holidayhackchallenge.com/static/profilepictures/elf3.png](/assets/img/posts/2024/2024-08-Drone-Path/downloaded/elf3.png) | Filo insists the best drones are the ones that can sneak up on you which is why he specializes in crafting silent stealthy models. <br/>He is always got a mischievous grin especially when his latest creation flies circles around you before you notice! |
  | fritjolf | ![https://hhc24-dronepath.holidayhackchallenge.com/static/profilepictures/elf5.png](/assets/img/posts/2024/2024-08-Drone-Path/downloaded/elf5.png) | Secret project is underway we need to produce as many as possible for Wombley. |
  | lira | ![https://hhc24-dronepath.holidayhackchallenge.com/static/profilepictures/elf17.png](/assets/img/posts/2024/2024-08-Drone-Path/downloaded/elf17.png) | Liras light touch and nimble fingers can assemble a drone in the blink of an eye sometimes before you even realize she has started.<br/>She swears each one has a bit of her own magic which might explain why they always seem to hum a little tune. |
  | pip | ![https://hhc24-dronepath.holidayhackchallenge.com/static/profilepictures/2cf1d29136d246eeb42149e65358abb3.png](/assets/img/posts/2024/2024-08-Drone-Path/downloaded/2cf1d29136d246eeb42149e65358abb3.png) | Pip is a master of drone delivery programming routes with such precision that packages arrive exactly on the second they are expected. <br/>He has a large collection of flags impressive! |
  | sprigg | ![https://hhc24-dronepath.holidayhackchallenge.com/static/profilepictures/elf13.png](/assets/img/posts/2024/2024-08-Drone-Path/downloaded/elf13.png) | Sprigg loves nothing more than the hum of a well-oiled drone and the smell of enchanted gears.<br/>When he is not tinkering he is dreaming up new ways to make drones faster shinier and maybe even capable of brewing tea! |
  | tylwen | ![https://hhc24-dronepath.holidayhackchallenge.com/static/profilepictures/elf6.png](/assets/img/posts/2024/2024-08-Drone-Path/downloaded/elf6.png) | Tylwen is the drone workshops resident perfectionist spending hours polishing every cog and checking each spell-infused circuit. <br/>She insists that drones can be practical and pristine and she wo not let one leave her station without a flawless gleam. |
...
![08_05_DronePath_elf_hawk_kml.png](/assets/img/posts/2024/2024-08-Drone-Path/08_05_DronePath_elf_hawk_kml.png)
...
![08_06_DronePath_elf_hawk_folium.png](/assets/img/posts/2024/2024-08-Drone-Path/08_06_DronePath_elf_hawk_folium.png)

### DroneDataAnalystExpertMedal
The sentence was the answer and could be confirmed using it in the Admin console:
![08_07_DronePath_DroneDataAnalystExpertMedal.png](/assets/img/posts/2024/2024-08-Drone-Path/08_07_DronePath_DroneDataAnalystExpertMedal.png)
...
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
```
![08_09_DronePath_EXPERTTURKEYCARVERMEDAL.png](/assets/img/posts/2024/2024-08-Drone-Path/08_09_DronePath_EXPERTTURKEYCARVERMEDAL.png)
...
* I tried to convert `0`s and `1`s to numbers and then plot it... ![08_08_DronePath_AtLeastTheNetherlandsWasNotHit.png](/assets/img/posts/2024/2024-08-Drone-Path/08_08_DronePath_AtLeastTheNetherlandsWasNotHit.png)
